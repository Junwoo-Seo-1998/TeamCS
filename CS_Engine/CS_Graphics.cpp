...
void CS_Graphics::Draw(Transform_Component& transform, const std::vector<VertexPosition2fTexture2f>& to_draw , int DrawType)
{
    ...
    GraphicsInfo::shader.SendUniformVariable("color", CS_Color{ 255,255,255 });
